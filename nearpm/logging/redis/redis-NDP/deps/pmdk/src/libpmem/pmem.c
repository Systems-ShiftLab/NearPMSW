...
{
	//printf("move_nodrain %ld src %p dest %p\n",len,src,pmemdest);
...
{
	//printf("memcpy_nodrain %ld src %p dest %p\n",len,src,pmemdest);
	LOG(15, "pmemdest %p src %p len %zu", pmemdest, src, len);
...
{
	//printf("memmove_persist %ld src %p dest %p\n",len,src,pmemdest);
	LOG(15, "pmemdest %p src %p len %zu", pmemdest, src, len);
...
{
	//printf("memcpy_persist %ld src %p dest %p\n",len,src,pmemdest);
	LOG(15, "pmemdest %p src %p len %zu", pmemdest, src, len);
...
{
	//printf("memset_nodrain %ld dest %p\n",len, pmemdest);
...
{
	//printf("memset_persist %ld dest %p\n",len,pmemdest);
	LOG(15, "pmemdest %p c %d len %zu", pmemdest, c, len);
